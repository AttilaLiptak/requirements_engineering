...
\begin{table}[H]
    ...
    \textbf{FMEA} & Failure Mode and Effects Analysis. Hibamód- és hatáselemzés. Egy szisztematikus eljárás a lehetséges rendszerhibák, azok okainak és hatásainak feltárására már a tervezési fázisban.\\
    \end{tabularx}
\end{table}